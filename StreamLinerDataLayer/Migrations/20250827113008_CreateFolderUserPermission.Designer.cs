...
namespace StreamLinerDataLayer.Migrations
{
    ...
    [Migration("20250827113008_CreateFolderUserPermission")]
    partial class CreateFolderUserPermission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StreamLinerEntitiesLayer.Entities.FolderPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StreamLinerEntitiesLayer.Entities.FolderUserPermission", b =>
                {
                    ...
                    b.HasOne("StreamLinerEntitiesLayer.Entities.FolderPermission", "FolderPermission")
                        .WithMany()
                        .HasForeignKey("FolderPermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
