...
namespace StreamLinerDataLayer.Migrations
{
    ...
    [Migration("20250902122817_ModifyRepositoriesDisk1")]
    partial class ModifyRepositoriesDisk1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StreamLinerEntitiesLayer.Entities.PermissionScope", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StreamLinerEntitiesLayer.Entities.PermissionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StreamLinerEntitiesLayer.Entities.RepoPermissionType", b =>
                {
                    b.Property<int>("RepoPermissionTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RepoPermissionTypeId"));
                    ...
                    b.HasKey("RepoPermissionTypeId");

                    b.ToTable("RepoPermissionType");
                });

            modelBuilder.Entity("StreamLinerEntitiesLayer.Entities.RepoUserPermission", b =>
                {
                    b.Property<int>("RepoUserPermissionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RepoUserPermissionId"));
                    ...
                    b.HasKey("RepoUserPermissionId");

                    b.HasIndex("RepoPermissionTypeId");

                    b.HasIndex("RepositoryId");

                    b.HasIndex("UserId");

                    b.ToTable("RepoUserPermissions");
                });

            modelBuilder.Entity("StreamLinerEntitiesLayer.Entities.RepositoriesDisk", b =>
                {
                    b.Property<int>("RepositoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StreamLinerEntitiesLayer.Entities.FolderUserPermission", b =>
                {
                    ...
                    b.HasOne("StreamLinerEntitiesLayer.Entities.PermissionType", "PermissionType")
                        .WithMany()
            ...
            modelBuilder.Entity("StreamLinerEntitiesLayer.Entities.RepoUserPermission", b =>
                {
                    b.HasOne("StreamLinerEntitiesLayer.Entities.RepoPermissionType", "RepoPermissionType")
                        .WithMany()
                        .HasForeignKey("RepoPermissionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StreamLinerEntitiesLayer.Entities.RepositoriesDisk", "RepositoriesDisk")
                        .WithMany()
                    ...
                    b.Navigation("RepoPermissionType");

                    b.Navigation("RepositoriesDisk");
